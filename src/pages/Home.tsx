...
const BG_IMAGES = [
  'https://images.unsplash.com/photo-1599661046289-e31897856741?auto=format&fit=crop&q=80&w=1920',
  'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?auto=format&fit=crop&q=80&w=1920',
  'https://images.unsplash.com/photo-1541014285461-84067980ea0a?auto=format&fit=crop&q=80&w=1920',
  'https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?auto=format&fit=crop&q=80&w=1920',
  'https://images.unsplash.com/photo-1514222139-b576bb5ce003?auto=format&fit=crop&q=80&w=1920',
];
    ...
    <div className="min-h-screen pb-20 space-y-32">
      <section className="relative pt-20 pb-0 px-6 min-h-screen flex items-center overflow-hidden">
        ...
        <AnimatePresence mode="sync">
          ...
          >
            <img src={BG_IMAGES[currentBg]} alt="" className="w-full h-full object-cover" />
